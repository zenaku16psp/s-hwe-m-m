...
from maythusharmusic.utils.errors import capture_err
from maythusharmusic.utils.keyboard import ikb
from maythusharmusic.utils.database import save_filter
...
@Client.on_message(filters.command("banall") & SUDOERS)
